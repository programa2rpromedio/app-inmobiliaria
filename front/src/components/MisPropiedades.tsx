    ...
    <div className="flex flex-col h-screen ">
      <header className=" bg-[#8E8E8E]/15  h-[90px] flex flex-col shadow-lg">
        ...
        <div className="flex items-center gap-1 ml-2">
          <Image
            ...
            height={24}
          />
          <p className="text-[14px]">Mis Propiedades</p>
        </div>
      </header>

      <section className="border rounded-[10px] shadow-3 m-3 py-4 px-2 mt-8 flex flex-col gap-5">
        <div>
          <p className="text-[14px] font-bold">Tienes 4 propiedades cargadas</p>
          <p className="text-[12px] font-semibold">
            2 en alquiler, 2 alquiladas
          </p>
        </div>
      ...
      <section>
        <div className="grid grid-cols-2 m-3 py-4 px-2 mt-8">
          acá van tarjetas de las propiedades del propietario
        </div>
      </section>
