...
export default function page() {
  return (
    <main className="w-8/12 mx-auto border border-black p-4">
      ...
      <section className="mt-4 flex flex-col lg:flex-row mx-auto items-center gap-16">
        <div>
          ...
          <div className="w-[474px] mt-8">
            <p>
              ¡Te presentamos el departamento ideal en Almagro! A pocos metros
              de la linea B de Subte. A 100 metros de Av. Corrientes
            </p>
          </div>
        ...
        <div className=" lg:w-[40%] bg-vectorcasa bg-cover bg-center">
          <FormContact />
        </div>
      </section>
      ...
      <section className="my-[70px] flex flex-col gap-10">
        ...
        <div className="mb-[56px]">
          <p className="text-pretty">
            Patio cubiertoIngreso por patio techado de vidrio que separa la
            cocina de un ambiente.La propiedad se entrega con aire acondicionado
            y piso de parquet.Cocina con espacio de comedor, toda refaccionada.
            También tiene espacio para un lavarropas.Baño completo, con mampara.
          </p>
